...
function NonFinancialReportContent() {
      ...
      <div className="modern-report-container">
        ...
        <div className="report-header no-print">
          <div className="report-brand">
            ...
            <div>
              <h1 className="brand-title">Non-Financial Report</h1>
              <p className="brand-subtitle">
                {data.length > 0 && fromDate && toDate ? `Between the dates ${fromDate} and ${toDate}` : 'Pending Orders Overview'}
              </p>
            </div>
          </div>
        ...
        <div className="print-only-header print-only" style={{ textAlign: 'center', marginBottom: 24, borderBottom: 'none' }}>
          <h2 style={{ fontSize: 18, marginBottom: 6 }}>Non Financial Report{fromDate && toDate ? ` Between the dates ${fromDate} and ${toDate}` : ''}</h2>
                ...
                {data.map((bill: any) => {
                  ...
                  return (
                    <tr key={bill.id} className="table-row">
                      ...
                      <td align="center" className="cell-age">{bill.patient.age ? `${bill.patient.age}y` : '-'}</td>
                      <td><span className={`gender-badge ${genderClass}`}>{genderText}</span></td>
                      <td className="cell-orders">{ordersStr}</td>
                      <td className="cell-source">{bill.patient.source || 'DR SELF'}</td>
                    </tr>
                  );
                })}
                {data.length === 0 && (
...
export default function NonFinancialReport() {
  return (
    <Suspense fallback={<div>Loading...</div>}>
      <NonFinancialReportContent />
    </Suspense>
  );
}
