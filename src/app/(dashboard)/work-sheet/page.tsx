...
import { ClipboardList, Calendar, FileDigit, ArrowRight } from 'lucide-react';
...
export default function WorkSheetPage() {
  ...
  // Set default dates to today (YYYY-MM-DD for native input date)
  useEffect(() => {
  ...
  useEffect(() => {
    const handleAction = (e: any) => {
      if (e.detail === 'Clear') {
        ...
        // Convert YYYY-MM-DD to DD-Mon-YYYY safely without timezone shifts
        ...
        window.open(`/reports/in-process/work-sheet-index?${query}`, '_blank');
      }
    };
  ...
  return (
    <div className="worksheet-container">
      <div className="worksheet-header">
        <h1 className="worksheet-title">Work Sheet Configuration</h1>
        <p className="worksheet-subtitle">Select date range and bill numbers to generate the laboratory worksheet</p>
      </div>
        ...
        <div className="card-inner">
          <div className="card-heading">
            ...
            <div>
              ...
              <p>Define the scope of the worksheet report</p>
            </div>
          </div>
          ...
          <div className="form-grid">
            ...
            {/* Bill Section */}
            <div className="form-section">
              <div className="section-label">Bill Number Range <span className="optional-badge">Optional</span></div>
              <div className="input-row">
                <div className="input-group">
                  <label>Start Bill No.</label>
                  <div className="input-wrapper">
                    <FileDigit className="input-icon" size={16} />
                    <input 
                      type="text" 
