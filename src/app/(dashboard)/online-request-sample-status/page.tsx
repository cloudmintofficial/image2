...
export default function OnlineRequestSampleStatusConfigPage() {
  ...
  useEffect(() => {
    const handleAction = (e: any) => {
      if (e.detail === 'Clear') {
        ...
        window.open(`/reports/in-process/online-request-sample-status?${query}`, '_blank');
      }
    };
  ...
  return (
    <div className="worksheet-container">
      <div className="worksheet-header">
        <h1 className="worksheet-title">Online Request Status Config</h1>
        <p className="worksheet-subtitle">Select date range to generate the sample status report</p>
      </div>

      <div className="worksheet-card">
        <div className="card-top-accent" style={{ background: 'linear-gradient(135deg, #8b5cf6, #6d28d9)' }}></div>
        <div className="card-inner">
          <div className="card-heading">
            <div className="heading-icon" style={{ background: '#f5f3ff', color: '#8b5cf6', boxShadow: '0 4px 12px rgba(139, 92, 246, 0.15)' }}>
              <Globe size={22} strokeWidth={2.5} />
            </div>
            <div>
              <h2>Filter Parameters</h2>
              <p>Define the scope of the online request report</p>
            </div>
          </div>
      ...
      <style>{`
        ...
        .input-wrapper input:focus { outline: none; border-color: #8b5cf6; background: #ffffff; box-shadow: 0 0 0 4px rgba(139, 92, 246, 0.1); }
        ...
        .hint-indicator { width: 8px; height: 8px; background: #8b5cf6; border-radius: 50%; box-shadow: 0 0 0 4px rgba(139, 92, 246, 0.2); }
