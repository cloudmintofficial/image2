...
export default function NonFinancialStatusConfigPage() {
  ...
  useEffect(() => {
    const handleAction = (e: any) => {
      if (e.detail === 'Clear') {
        ...
        window.open(`/reports/in-process/non-financial-status?${query}`, '_blank');
      }
    };
  ...
  return (
    <div className="worksheet-container">
      <div className="worksheet-header">
        <h1 className="worksheet-title">Non-Financial Status Report Config</h1>
        <p className="worksheet-subtitle">Select date range to generate the status report</p>
      </div>

      <div className="worksheet-card">
        <div className="card-top-accent" style={{ background: 'linear-gradient(90deg, #10b981, #059669)' }}></div>
        <div className="card-inner">
          <div className="card-heading">
            <div className="heading-icon" style={{ background: '#ecfdf5', color: '#10b981', boxShadow: '0 4px 12px rgba(16, 185, 129, 0.15)' }}>
              <Activity size={22} strokeWidth={2.5} />
            </div>
            <div>
              <h2>Filter Parameters</h2>
              <p>Define the scope of the status report</p>
            </div>
          </div>
      ...
      <style>{`
        ...
        .input-wrapper input:focus { outline: none; border-color: #10b981; background: #ffffff; box-shadow: 0 0 0 4px rgba(16, 185, 129, 0.1); }
        ...
        .hint-indicator { width: 8px; height: 8px; background: #10b981; border-radius: 50%; box-shadow: 0 0 0 4px rgba(16, 185, 129, 0.2); }
